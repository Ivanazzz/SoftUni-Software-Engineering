...
namespace TestAxe.Test
{
    ...
    public class AxeTests
    {
        ...
        [Test]
        public void Test_AxeShouldLoseDurabiltyPointsAfterEachAttack()
        {
            for (int i = 0; i < 5; i++)
            {
                axe.Attack(dummy);
        ...
        [Test]
        public void Test_AxeAttackShouldThrowExceptionWhenDurabilityPointsAreZero()
        {
            axe = new Axe(10, 0);
        ...
        [Test]
        public void Test_AxeAttackShouldThrowExceptionWhenDurabilityPointsAreNegative()
        {
            axe = new Axe(10, -5);
